...
//			uint64_t& time_traversal, uint64_t& time_abort, uint64_t& time_latch, uint64_t& time_node, uint64_t& time_split, bool& abort);
//	#else
...
// 	#endif
	...
	inline void findDepth(uint64_t& leaf_cnt, uint64_t& leaf_depth, uint64_t& max_depth) const;
	inline void getMemory(HOTRowexChildPointer const& node, uint64_t& meta, uint64_t& structural_data_occupied, uint64_t& structural_data_unoccupied, uint64_t& key_data_occupied, uint64_t& key_data_unoccupied) const;
	inline void getMemory(uint64_t& meta, uint64_t& structural_data_occupied, uint64_t& structural_data_unoccupied, uint64_t& key_data_occupied, uint64_t& key_data_unoccupied) const;
private:
