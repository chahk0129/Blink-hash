...
if (len(sys.argv) != 3) :
    ...
    print 'workload file output_path' + bcolors.ENDC
...
out_ycsb_load = output_dir + '/ycsb_load_' + key_type + '_' + workload + '_' + skew
out_ycsb_txn = output_dir + '/ycsb_txn_' + key_type + '_' + workload + '_' + skew
out_load_ycsbkey = output_dir + '/load_' + 'ycsbkey' + '_' + workload + '_' + skew
out_txn_ycsbkey = output_dir + '/txn_' + 'ycsbkey' + '_' + workload + '_' + skew
out_load = output_dir + '/load_' + key_type + '_' + workload + '_' + skew
out_txn = output_dir + '/txn_' + key_type + '_' + workload + '_' + skew

cmd_ycsb_compile = 'mvn -pl site.ycsb:core -am package'
cmd_ycsb_load = 'bin/ycsb load basic -P ' + workload_dir + workload + ' -s > ' + out_ycsb_load
cmd_ycsb_txn = 'bin/ycsb run basic -P ' + workload_dir + workload + ' -s > ' + out_ycsb_txn

os.chdir(os.path.expanduser(ycsb_dir))
os.system(cmd_ycsb_compile)
