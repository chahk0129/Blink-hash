...
workload.o: src/workload.cpp include/microbench.h include/index.h include/util.h index/masstree/mtIndexAPI.hh index/BwTree/bwtree.h index/hot/src/wrapper.h src/papi_util.cpp index/blink/tree_optimized.h pcm/pcm-memory.cpp pcm/pcm-numa.cpp
	...
	$(CXX) $(CFLAGS) -c -o obj/workload_convert.o src/workload.cpp $(LDFLAGS) $(PROFFLAGS) -DCONVERT
...
workload: workload.o bwtree.o artolc.o artrowex.o index/masstree/mtIndexAPI.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a index/blink/tree_optimized.h index/blink-hash/build/lib/libblinkhash.a
	$(CXX) $(CFLAGS) -o bin/workload obj/workload.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/blink-hash/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb -DLINKED -DSAMPLING -DAVX2 -DOLD
	$(CXX) $(CFLAGS) -o bin/workload_convert obj/workload_convert.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/blink-hash/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb -DUPDATE_LOCK -DLINKED -DSAMPLING -DAVX2 -DOLD -DCONVERT
...
timeseries.o: src/timeseries.cpp include/microbench.h include/index.h include/util.h index/masstree/mtIndexAPI.hh index/BwTree/bwtree.h index/hot/src/wrapper.h src/papi_util.cpp index/blink/tree_optimized.h pcm/pcm-memory.cpp pcm/pcm-numa.cpp
	$(CXX) $(CFLAGS) -c -o obj/timeseries.o src/timeseries.cpp $(LDFLAGS) $(PROFFLAGS)

timeseries: timeseries.o bwtree.o artolc.o artrowex.o index/masstree/mtIndexAPI.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a index/blink/tree_optimized.h index/blink-hash/build/lib/libblinkhash.a
	$(CXX) $(CFLAGS) -o bin/timeseries obj/timeseries.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/blink-hash/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb -DLINKED -DSAMPLING -DAVX2

workload_string.o: src/workload_string.cpp include/microbench.h include/index.h include/util.h index/masstree/mtIndexAPI.hh index/BwTree/bwtree.h index/hot/src/wrapper.h index/blink-hash-str/src/wrapper.h index/blink/tree_optimized.h
...
workload_string: workload_string.o bwtree.o artolc.o artrowex.o index/masstree/mtIndexAPI.a index/hot/build/src/libhot-rowex.a index/blink/tree_optimized.h index/blink-hash-str/build/lib/libblinkhash.a
	$(CXX) $(CFLAGS) -o bin/workload_string obj/workload_string.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/hot/build/src/libhot-rowex.a index/blink-hash-str/build/lib/libblinkhash.a index/blink/tree.h $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb  -DSTRING_KEY -DUPDATE_LOCK
	$(CXX) $(CFLAGS) -o bin/breakdown_workload_string obj/workload_string_breakdown.o obj/bwtree_breakdown.o obj/artolc_breakdown.o obj/artrowex_breakdown.o index/masstree/mtIndexAPI.a index/blink-hash-str/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex-breakdown.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb  -DSTRING_KEY -DBREAKDOWN
