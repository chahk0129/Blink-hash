...
timeseries.o: src/timeseries.cpp include/microbench.h include/index.h include/util.h index/masstree/mtIndexAPI.hh index/BwTree/bwtree.h index/hot/src/wrapper.h src/papi_util.cpp index/BTreeOLC/BTreeOLC_adjacent_layout.h index/blink/tree_optimized.h index/blink-hash/lib/tree.h index/blink-buffer/lib/run.h index/blink-buffer-batch/lib/run.h pcm/pcm-memory.cpp pcm/pcm-numa.cpp
...
timeseries: timeseries.o bwtree.o artolc.o artrowex.o index/masstree/mtIndexAPI.a index/hot/build/src/libhot-rowex.a pcm/libPCM.a index/blink/tree_optimized.h index/blink-hash/build/lib/libblinkhash.a index/blink-buffer/build/lib/libblink_buffer.a index/blink-buffer/build/lib/libblink_buffer_flush.a index/blink-buffer-batch/build/lib/libblink_buffer_batch.a index/blink-buffer-batch/build/lib/libblink_buffer_batch_flush.a pcm/libPCM.a
	$(CXX) $(CFLAGS) -o bin/timeseries obj/timeseries.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/blink-hash/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex.a index/blink-buffer/build/lib/libblink_buffer.a index/blink-buffer-batch/build/lib/libblink_buffer_batch.a pcm/libPCM.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb
	$(CXX) $(CFLAGS) -o bin/timeseries_flush obj/timeseries.o obj/bwtree.o obj/artolc.o obj/artrowex.o index/masstree/mtIndexAPI.a index/blink-hash/build/lib/libblinkhash.a index/hot/build/src/libhot-rowex.a index/blink-buffer/build/lib/libblink_buffer_flush.a index/blink-buffer-batch/build/lib/libblink_buffer_batch_flush.a pcm/libPCM.a $(MEMMGR) $(LDFLAGS) $(PROFFLAGS) -lpthread -lm -ltbb -DFLUSH
